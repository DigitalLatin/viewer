var appcrit = (function () {
  ...
  var appcrit = function () {
  	function appcrit(c) {
  		...
  		this.ceteicean = c;
  		this.variantBlocks = "tei-l,tei-speaker,tei-seg";
  		this.genId = 0;
  		this.dom = null;
  		this.references = {};
  		this.log = [];
  		...
  		value: function doSection(section) {
  			...
  			if (section.find("tei-app").length > 0) {
  				(function () {
  					...
  					// Add line numbers
  					var parents = ["tei-sp", "tei-ab", "tei-div", "tei-lem", "tei-lg", "tei-p"];
            ...
            $("span.apps").each(function(i, e) {$(e).css("left", e.parentElement.parentElement.getBoundingClientRect()["width"] - (e.getBoundingClientRect()["left"] - e.parentElement.parentElement.getBoundingClientRect()["left"]) + 10)});
